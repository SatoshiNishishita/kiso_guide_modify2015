		 		...
		 		<div class="col-xs-6">
					...
					<h4 class="text-center"><?php echo $photo_data['photo_text'];?></h4>
			 		<form action="input.php" method="post">
						<input type="hidden" name = "photoid" value = "<?php echo $photo_data[ 'photo_id'];?>" />
							<div class="form-group">
								<p>この動画の表示/非表示を選択する</p>
								<div class="radio-inline">
									<input type="radio" value="1" name="photoindication" id ="hyouzi" checked>
									<label for = "man">表示</label>
								</div>
								<div class="radio-inline">
									<input type="radio" value="0" name="photoindication" id ="hihyouzi">
